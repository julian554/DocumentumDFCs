...
public class PantallaApi extends javax.swing.JFrame {
    ...
    String idControl = "";
    IDfSession gsesion;
    String textoAyudaApi = "";
    PantallaAyudaApi pantallaAyuda = new PantallaAyudaApi(this, true);
    ArrayList<Pistas> listaPistasApi = utildocum.leerDatosAyuda("ayuda-api.xml");
    StyleContext styleContext = new StyleContext();
    Style defaultStyle = styleContext.getStyle(StyleContext.DEFAULT_STYLE);
    Style cwStyle = styleContext.addStyle("ConstantWidth", null);
    Style comillaStyle = styleContext.addStyle("ConstantWidth", null);

    public void setTextoAyudaApi(String textoAyudaApi) {
        this.textoAyudaApi = textoAyudaApi;
        textoAPI.setText(textoAyudaApi);
    }
    ...
    public PantallaApi(PantallaDocumentum parent, boolean modal) {
        ...
        /**
         * ******************************************************
         * Filtra la pulsación de Enter en un campo JTextPane *****************************************************
         */
        int condition = JComponent.WHEN_FOCUSED;
        InputMap iMap = textoAPI.getInputMap(condition);
        ActionMap aMap = textoAPI.getActionMap();
        String enter = "enter";
        iMap.put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), enter);
        aMap.put(enter, new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
                botonConsultar.requestFocus();
            }
        });

        /*
        Define los estilos a aplicar en ek JTextPane
         */
        StyleConstants.setForeground(cwStyle, Color.BLUE);
        StyleConstants.setItalic(cwStyle, true);
        StyleConstants.setBold(cwStyle, true);
        int tamletra = textoAPI.getFont().getSize();
        textoAPI.setFont(new Font(textoAPI.getFont().getFontName(), Font.BOLD, tamletra + 2));
    }
    ...
    protected static Image getLogo() {
        ...
        java.net.URL imgURL = PantallaDocumentum.class.getClassLoader().getResource("es/documentum/imagenes/api-nuevo.png");
    ...
    private void initComponents() {
        ...
        textoAPI = new javax.swing.JTextPane(new CambiarColorTexto(defaultStyle, cwStyle, comillaStyle , "api"));
        ...
        textoMultiAPI.setFont(new java.awt.Font("Monospaced", 1, 13)); // NOI18N
        ...
        botonConsultar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/es/documentum/imagenes/api-exec.png"))); // NOI18N
        ...
        textoLog.setFont(new java.awt.Font("Consolas", 1, 12)); // NOI18N
        ...
        textoDatosApi.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        textoDatosApi.setMinimumSize(new java.awt.Dimension(6, 24));
        textoDatosApi.setPreferredSize(new java.awt.Dimension(6, 24));
        textoDatosApi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                textoDatosApiMousePressed(evt);
            }
        });
        ...
        textoAPI.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        textoAPI.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        textoAPI.setMinimumSize(new java.awt.Dimension(6, 24));
        textoAPI.setPreferredSize(new java.awt.Dimension(6, 24));
        textoAPI.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                textoAPIMousePressed(evt);
            }
        });
        ...
        botonAyuda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/es/documentum/imagenes/api-ayuda.png"))); // NOI18N
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelAPILayout.createSequentialGroup()
                        .addGroup(panelAPILayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(panelAPILayout.createSequentialGroup()
                                ...
                                .addGap(169, 169, 169)
                                .addComponent(checkMostrarSQL, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(15, 15, 15))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelAPILayout.createSequentialGroup()
                                .addComponent(textoAPI, javax.swing.GroupLayout.DEFAULT_SIZE, 866, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(botonAyuda, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelAPILayout.createSequentialGroup()
                                .addComponent(textoDatosApi, javax.swing.GroupLayout.DEFAULT_SIZE, 866, Short.MAX_VALUE)
                                .addGap(36, 36, 36)))
                        .addGap(32, 32, 32)
                        .addGroup(panelAPILayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        opcionConsultar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/es/documentum/imagenes/api-exec.png"))); // NOI18N
    ...
    private void opcionCopiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opcionCopiarActionPerformed
        ...
        if (componente.equals("textoAPI")) {
            if (textoAPI.getSelectedText() == null) {
                Utilidades.copiarTextoPortapapeles(textoAPI.getText());
            } else {
                Utilidades.copiarTextoPortapapeles(textoAPI.getSelectedText());
            }
        }
        if (componente.equals("textoDatosApi")) {
            if (textoDatosApi.getSelectedText() == null) {
                Utilidades.copiarTextoPortapapeles(textoDatosApi.getText());
            } else {
                Utilidades.copiarTextoPortapapeles(textoDatosApi.getSelectedText());
            }
        }
    ...
    private void opcionPegarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opcionPegarActionPerformed
        if (componente.equals("textoAPI")) {
            textoAPI.setText(Utilidades.pegarTextoPortapapeles());
        }
        if (componente.equals("textoDatosApi")) {
            textoDatosApi.setText(Utilidades.pegarTextoPortapapeles());
        }
        if (componente.equals("textoMultiAPI")) {
            int caretPos = textoMultiAPI.getCaretPosition();
            try {
                textoMultiAPI.getDocument().insertString(caretPos, Utilidades.pegarTextoPortapapeles(), null);
            } catch (BadLocationException ex) {
                Utilidades.escribeLog("Error al pegar texto en 'textoMultiAPI' - " + ex.getMessage());
            }
        }
    ...
    private void textoAPIMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_textoAPIMousePressed
        if (evt.getButton() == java.awt.event.MouseEvent.BUTTON3) {
            botonderecho = true;
            componente = "textoAPI";
            popupmenu(evt);
        }
    }//GEN-LAST:event_textoAPIMousePressed

    private void textoDatosApiMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_textoDatosApiMousePressed
        if (evt.getButton() == java.awt.event.MouseEvent.BUTTON3) {
            botonderecho = true;
            componente = "textoDatosApi";
            popupmenu(evt);
        }
    }//GEN-LAST:event_textoDatosApiMousePressed

    private void botonAyudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAyudaActionPerformed
        int x = textoAPI.getX() + this.getX() + 9;
        int y = textoAPI.getY() + this.getY() + 85;
        pantallaAyuda.setBounds(x, y, textoAPI.getWidth(), 300);
        pantallaAyuda.setTexto("");
    ...
    private void textoAPIKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoAPIKeyReleased
        ...
        int pos = textoAPI.getText().indexOf(",");
        if (pos < 0) {
            pos = textoAPI.getText().indexOf(" ");
        }

        if (pos > 0) {
            palabra = textoAPI.getText().substring(0, pos);
        }

        if (!palabra.isEmpty()) {
            String sintaxisApi = utildocum.buscarSintaxis(palabra, listaPistasApi, "sintaxis");
            if (!sintaxisApi.isEmpty()) {
                String textoHtml
                        = "<html><p><b><font color=\"#0e007d\" "
                        + "size=\"4\" face=\"Verdana\">" + sintaxisApi
                        + "</font></b></p></html>";
                UIManager.put("ToolTip.background", new Color(250, 250, 205));
                textoAPI.setToolTipText(textoHtml);
            }
        } else {
            textoAPI.setToolTipText("");
        }
    ...
    private void popupmenu(MouseEvent evt) {
        if (evt.isPopupTrigger() || botonderecho) {
            ...
            if (componente.equalsIgnoreCase("textoMultiAPI")) {
                opcionPegar.setVisible(true);
                popupEditar.show(evt.getComponent(), evt.getX(), evt.getY());
            }
            if (componente.equalsIgnoreCase("textoAPI")) {
                opcionPegar.setVisible(true);
                popupEditar.show(evt.getComponent(), evt.getX(), evt.getY());
            }
            if (componente.equalsIgnoreCase("textoDatosApi")) {
                opcionPegar.setVisible(true);
                popupEditar.show(evt.getComponent(), evt.getX(), evt.getY());
            }
            if (componente.equalsIgnoreCase("textoLog")) {

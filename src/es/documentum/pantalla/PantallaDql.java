...
public class PantallaDql extends javax.swing.JFrame {
    ...
    public PantallaDql(PantallaDocumentum parent, boolean modal) {
        ...
        TextoNumLineasExcel.setEditable(false);
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelResultado, javax.swing.GroupLayout.DEFAULT_SIZE, 1108, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addComponent(panelResultado, javax.swing.GroupLayout.DEFAULT_SIZE, 289, Short.MAX_VALUE)
                .addGap(1, 1, 1)
...
//                EtiquetaEstado.setText(resultado);
    ...
    private void checkMultiplesDqlsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkMultiplesDqlsActionPerformed
        if (checkMultiplesDqls.isSelected()) {
            ...
            TextoNumLineasExcel.setEditable(true);
        } else {
...
//                        Color alternateColor = DefaultLookup.getColor(this, ui, "Table.alternateRowColor");
    ...
    private IDfCollection ejecutarDescribe(String dql, IDfSession sesion) {
        ...
        if (dql.toLowerCase().contains(" table ")) {
            ...
            if (tabla.trim().endsWith(";")) {
                tabla = tabla.trim().substring(0, tabla.length() - 1);
            }
        ...
        if (modelo != null) {
            for (int i = 0; i < modelo.getSize(); i++) {
                if (cadena.equalsIgnoreCase(modelo.getElementAt(i).toString().trim())
                        || cadena.equalsIgnoreCase(modelo.getElementAt(i).toString().trim() + ";")) {
                    return i;
                }
            }
        } else {

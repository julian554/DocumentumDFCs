...
public class Acercade extends javax.swing.JDialog {
    ...
    private void valoresPc(Boolean Conectado) {
        ...
        try {
            ResourceBundle rb = ResourceBundle.getBundle("es/documentum/propiedades/version");
            String build = rb.getString("BUILD");
            String nomapp = rb.getString("nombre");
            String verapp = rb.getString("version");
            labelVersion.setText(nomapp + " v. " + verapp + " " + pc.rellenarPorIzquierda(build + "", "0", 3));

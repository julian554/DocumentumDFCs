...
public class PosicionEnSql {
    ...
    static String gestorBBDD;

    public static String getGestorBBDD() {
        return gestorBBDD;
    }
    ...
    public String format(String sql, String gestorBBDD) {
        setGestorBBDD(gestorBBDD);

        if (sql == null || sql.length() == 0) {
            return "inicio";
        }
        if (sql.toLowerCase(Locale.ROOT).startsWith("create table") || sql.toLowerCase(Locale.ROOT).startsWith("alter table")) {
            return "tablas";
        }
    ...
    private static class FormatProcess {
        ...
        private void out() {
            if (util.esPalabraReservadaSQL(token, getGestorBBDD())) {
